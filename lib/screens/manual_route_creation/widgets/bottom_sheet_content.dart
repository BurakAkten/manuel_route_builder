...
class BottomSheetContent extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
      decoration: const BoxDecoration(color: Colors.white, border: Border(top: BorderSide(color: Color(0xFFE0DDD6), width: 0.5))),
            ...
            children: [
              Expanded(
                  child: _PrimaryButton(
                      label: ManuelRouteBuilderConfig.l10n.reset, onPressed: parent.onResetFreeDraw, color: parent.primaryColor.withOpacity(0.4))),
              const SizedBox(width: 4),
              Expanded(
                  child:
                      _PrimaryButton(label: ManuelRouteBuilderConfig.l10n.continueButton, onPressed: parent.onNextStep, color: parent.primaryColor)),
            ],
          ),
        ],
      ],
